                            ...
                            <a href="/buyer/items/detail?id=${single_item.id}" class="product-title">${single_item.itemName}
                                ...
                                <span class="label label-danger pull-right">
                                    <form role="form" method="post">
                                        ...
                                        <button type="submit" class="btn btn-danger btn-xs" onclick="javascript: form.action='./favorite_infos/delete?item_id=${single_item.getId()}&page=${currentPage}';"><span class="fa fa-trash"></span></button>
                                    </form>
                                </span><br>
                            </a>
