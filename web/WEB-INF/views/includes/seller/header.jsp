...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="#" class="logo">
            ...
            <span class="logo-mini">卖家</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">卖家</span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li><a href="/seller/"><i class="fa fa-home"></i> <span>首页</span></a></li>
                <li><a href="/seller/items"><i class="fa fa-gift"></i> <span>商品管理</span></a></li>
                <li><a href="/seller/orders"><i class="fa fa-sticky-note-o"></i> <span>订单管理</span></a></li>
                <li><a href="/seller/rank_infos"><i class="fa fa-smile-o"></i> <span>评价管理</span></a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
