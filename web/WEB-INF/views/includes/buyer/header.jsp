...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="#" class="logo">
            ...
            <span class="logo-mini">买家</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">买家</span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li><a href="/buyer/"><i class="fa fa-home"></i> <span>首页</span></a></li>
                <li><a href="/buyer/items"><i class="fa fa-gift"></i> <span>商品浏览</span></a></li>
                <li><a href="/buyer/cart_infos"><i class="fa fa-cart-plus"></i> <span>购物车管理</span></a></li>
                <li><a href="/buyer/favorite_infos"><i class="fa fa-heart"></i> <span>收藏管理</span></a></li>
                <li><a href="/buyer/orders"><i class="fa fa-sticky-note-o"></i> <span>订单管理</span></a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
