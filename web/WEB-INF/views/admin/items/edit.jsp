...
<!-- Content Header (Page header) -->
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">商品编辑<small>ID:${Item.id}</small></h3>
        </div>
        <form role="form" action="/admin/items/edit?page=${currentPage}&id=<%=request.getParameter("id")%>" method="post">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label>商品头图</label>
                    <div id="item_img_upload"><input type="file" name="files[]" id="item_img_uri" accept=".png,.jpg,.bmp" data-url="https://etrade-image.wetolink.com/index.php"></div>
