                ...
                <c:if test="${Order.status >= OrdersEntity.STATUS_RECEIVE_PENDING}">
                    <div class="col-sm-4 invoice-col">
                        ...
                        <address>
                            <div class="form-group">
                                <label>快递公司名称</label>
                                <input type="text" class="form-control" name="deliver_company" placeholder="请输入快递公司名称" required value="${Order.deliverCompany}" maxlength="16" disabled>
                            </div>
                            <div class="form-group">
                                <label>快递运单号</label>
                                <input type="number" class="form-control" name="deliver_order_id" placeholder="请输入快递单号" required value="${Order.deliverOrderId}" maxlength="16" disabled>
                            </div>
                        </address>
                    </div>
                </c:if>
